void get_wh24p() {
    ...
    unsigned int winddir = (bufferWH24P[3] << 1) & 256; winddir = winddir | (bufferWH24P[2]); //-- D(256) = B(0001 0000 0000)
    Serial.println(winddir,BIN);
    Serial.print(F("Wind direction: ")); Serial.print(winddir); Serial.println(F(" (degree)"));
    ...
    float windspd = windspdz/0.14;  //in m/s
    Serial.print(F("Wind speed: "));  Serial.print(windspd); Serial.println(F(" (m/s)"));
