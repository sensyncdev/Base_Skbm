...
void displayWind(){
  int windSpd=(random(5,35)); 
  int windDir=(random(10,360));
  tft.drawLine(0,95, tft.width(),95, ST77XX_WHITE);  
  tft.setTextColor(ST77XX_WHITE);
  tft.setCursor(5, 100);    tft.println("Wind:   km/h");
  tft.setTextColor(ST77XX_CYAN);
  tft.setCursor(40, 100);   tft.println(windSpd);
  tft.setCursor(90, 100);   //tft.println(wDir);
  DispDirection(windDir);
}
