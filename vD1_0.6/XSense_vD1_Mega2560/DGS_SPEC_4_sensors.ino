void get_4dgsspec_v2() {
  ...
  for (int c=28;c<=31;c++) {  //read data from 4 sensor by multiplexing the uart through enable pin. pin 28-31 are EN_SPEC pin
   ...
   switch (c) {
      case 28: Serial.print(" (SO2)");break;
      case 29: Serial.print(" (NO2)");break;
      case 30: Serial.print(" (O3)");break;
      case 31: Serial.print(" (CO)");break;
   }
   Serial.print(": ");
  ...
  while ((!isDataReceived) && (millis() - waktuLama <= 5000)){
   ...
   if(!isDataReceived) {
    ...
    switch (c) {
      case 28: currentData.ppbSO2 = 0; Serial.print("    currentData.ppbSO2 updated with value: "); Serial.println(currentData.ppbSO2);break;
      ...
      case 31: currentData.ppbCO = 0; Serial.print("    currentData.ppbCO updated with value: "); Serial.println(currentData.ppbCO);break;
    }
   }
   else {
...
//--begin pengolahan data
    // float datappb = float(arrayData[1].toInt()) / 1000;
    // if(datappb < 0) {datappb = 0.01;}
//--end pengolahan data
float datappb = float(arrayData[1].toInt());


//--input hasil parsing ppb
    //Serial.println(datappb);
    switch (c) {
      case 28: currentData.ppbSO2 = datappb; Serial.print("    currentData.ppbSO2 updated with value: "); Serial.println(currentData.ppbSO2);break;
      ...
      case 31: currentData.ppbCO = datappb; Serial.print("    currentData.ppbCO updated with value: "); Serial.println(currentData.ppbCO);break;
    }
   }
