...
#define isWifiConnect_PIN 33
bool firstSample_flag = false;
bool isWifiConnect = false;
#define PumpIsOn  HIGH
#define PumpIsOff LOW

//--------------------------------------------------- Server
  // const String base_id      = "id=4O5Z56Xu";
  // const String url_upload   = "http://128.199.194.1/ganitri/pd/sensor?";
  ...
  const String url_startup  = "http://server.getsensync.com/prtl/startup.php?id=cirebon";
  const String url_reset    = "http://server.getsensync.com/prtl/reset.php?id=cirebon";
